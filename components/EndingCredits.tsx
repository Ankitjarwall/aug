...
export function EndingCredits({ credits, fallbackImage, title, onClose }: { credits: Credit[]; fallbackImage: string; title: string; onClose: () => void }) {
  ...
  return <div className="credits-screen" role="dialog" aria-modal="true" aria-label="Ending credits">
    ...
    <div className="credits-photo"><img src={image} alt={title} /></div>
    <div className="credits-window"><div className="credits-roll">
      <p className="credits-kicker">{title}</p>
